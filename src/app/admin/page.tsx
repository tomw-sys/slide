    ...
    <main className="min-h-screen bg-[#100F0C]">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="mb-8">
          ...
          <p className="text-[#8a8575] text-sm">Make Agency internal dashboard.</p>
        </div>

        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-[#17150F] border border-[#3a3730] rounded-xl p-5">
            <p className="text-[#8a8575] text-xs uppercase tracking-wider mb-1">Creators</p>
            <p className="text-white text-3xl font-bold">{creatorsCount ?? 0}</p>
          </div>
          <div className="bg-[#17150F] border border-[#3a3730] rounded-xl p-5">
            <p className="text-[#8a8575] text-xs uppercase tracking-wider mb-1">Pending verif.</p>
          ...
          <div className="bg-[#17150F] border border-[#3a3730] rounded-xl p-5">
            <p className="text-[#8a8575] text-xs uppercase tracking-wider mb-1">Active rewards</p>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <Link
            href="/admin/creators"
            className="bg-[#17150F] border border-[#3a3730] rounded-xl p-6 hover:border-[#4a4640] transition-colors"
          >
